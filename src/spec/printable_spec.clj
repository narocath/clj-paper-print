...
(s/def ::printable-data? (s/alt :one (s/cat :a ::gs/action?   :c int? :d int? :e int? :f int?)
                                     ...
                                     :seven (s/cat :a ::gs/action?   :c ::gs/image? :d int? :e int?)
                                     :eight (s/cat :a ::gs/action?   :c ::gs/image? :d int? :e int? :f ::color?)
                                     :nine (s/cat :a ::gs/action?   :c ::gs/image? :d int? :e int? :f int? :g int?)
                                     :ten (s/cat :a ::gs/action?   :c ::gs/image? :d int? :e int? :f int? :g int? :h ::gs/color?)
                                     :eleven (s/cat :a ::gs/action?   :c ::gs/image? :d int? :e int? :f int? :g int? :h int? :i int? :j int? :k int?)
                                     :twelve (s/cat :a ::gs/action?   :c ::gs/image? :d int? :e int? :f int? :g int? :h int? :i int? :j int? :k int? :l ::gs/color?)
